...
def fetch_allevents(id):
	...
	# Make requests
	assignr = base.call("GET", baseurl + "/v1/calendar_events" , req_context, params=assignparams, auth_token=oauthtoken)
	eventr = base.call("GET", baseurl + "/v1/calendar_events" , req_context, params=eventparams, auth_token=oauthtoken)
